package com.mchsdk.paysdk.mylibrary.Utils;
...
import com.mchsdk.paysdk.mylibrary.R;
...
public class EyesUtils {
    ...
    public static void setStatus(Activity activity){   //沉浸效果
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {//5.0及以上
            ...
            if (useThemestatusBarColor) {
                activity.getWindow().setStatusBarColor(activity.getResources().getColor(R.color.bg_divider));//设置状态栏背景色
            } else {
